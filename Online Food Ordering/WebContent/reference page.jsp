  ...
  <tbody>
    <tr>
      <td height="684" align="center" valign="top"><table width="100%" border="0">
        <tbody>
          <tr>
            <td height="50" align="center" valign="middle" bgcolor="lightblue"><h1 style="font-family: 'Lucida Grande', 'Lucida Sans Unicode', 'Lucida Sans', 'DejaVu Sans', Verdana, sans-serif; font-size: xx-large;">FOOD FUN</h1></td>
          </tr>
          
        
              <tbody>
                <tr>
                  <td height="33" align="center" valign="middle" style="color: red">
            ...
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="single-food">
                        <div class="food-img">
                            <img src="food image1.jpeg" class="img-fluid" alt="">
                        </div>
